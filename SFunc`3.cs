...
namespace OneUpside.Data
{
  ...
  [DataContract]
  public sealed class SFunc<A,B,R>
  {
    [DataMember]
    ...
    /// <param name="b">Function argument</param>
    /// <returns>Function return value</returns>
    public R Apply(A a, B b)
    {
      var parameterTypes = new Type[] { typeof(A), typeof(B) };
      var method = 
        ...
        .First();
      return (R)method.Invoke(Data.Instance, new object[] { a, b });
    }
